...
public class CustomerFrame extends JFrame {
	...
	public CustomerFrame() {
        ...
        JLabel lblNewLabel = new JLabel("Customer Table");
        ...
        insertButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    PreparedStatement checkStatement = connection.prepareStatement("SELECT CustomerID FROM customers WHERE NIC = ?");
                    ...
                    if (checkResult.next()) {
                        ...
                        String sql = "INSERT INTO customers (FirstName, LastName, NIC, Email, Contact) VALUES ('" + Firstname + "','" + Lastname + "','" + Nic + "','" + Email + "','" + Contact + "')";
        ...
        updatebutton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		try {
        			int cusID=Integer.parseInt(table.getValueAt(table.getSelectedRow(),0).toString());
					Statement st=connection.createStatement();
					String sql="Update customers Set FirstName='"+Firstname+"',LastName='"+Lastname+"',NIC='"+Nic+"',Email='"+Email+"',Contact='"+Contact+"' Where CustomerID="+cusID;
					st.executeUpdate(sql);
					refreshTable();
        ...
        DeleteButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		try {
        			int cusID=Integer.parseInt(table.getValueAt(table.getSelectedRow(),0).toString());
					Statement st=connection.createStatement();
					String sql="Delete from customers Where CustomerID="+cusID;
					st.executeUpdate(sql);
					refreshTable();
        ...
        emailtextField.setBounds(110, 124, 237, 28);
        panel_1.add(emailtextField);
        
        contacttextField = new JTextField();
        contacttextField.setColumns(10);
        contacttextField.setBounds(110, 162, 237, 28);
        ...
        lblNewLabel_1_5_1.setBounds(22, 162, 78, 28);
		...
		contentPane.add(refreshButton);
	     ...
	     searchButton.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent e) {
	                ...
	                try {
	                    PreparedStatement st3 = connection.prepareStatement("SELECT * FROM customers WHERE CustomerID LIKE ? or FirstName LIKE ? ");
	                    for (int i = 1; i <= 2; i++) {
	...
	private void refreshTable() {
        ...
        try {
            PreparedStatement st3 = connection.prepareStatement("SELECT * FROM customers");
